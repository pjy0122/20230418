  ...
  return (
    <div className="max-w-screen-md mx-auto min-h-screen flex flex-col justify-start items-center pt-16 px-4">
      <form className="flex w-full" onSubmit={onSubmitChat}>
        ...
        />
        <input
          className={`w-24 ml-4 px-2 py-1 border-2 border-yellow-300 text-blue-300 rounded-lg shadow-lg ${
      ...
      {result && (
        <div className="mt-16 bg-yellow-300 p-4 text-black rounded-lg">
          {result}
        </div>
      )}
    </div>
